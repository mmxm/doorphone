...
from .filters import BookFilter, AuthorFilter, LoansFilter, UserFilter, QrAccessFilter
from .models import Author, Book, Loan, QrAccess
from .serializers import AuthorSerializer, BookSerializer, BookAuthorSimpleSerializer, UserGroupsSerializer, \
    LoanSerializer, UserSerializer, QrAccessSerializer
...
class UserViewSet(viewsets.ModelViewSet):
    ...
    ordering_fields = ('id', 'last_name', 'username', 'first_name')
...
class QrAccessViewSet(viewsets.ModelViewSet):
    queryset = QrAccess.objects.all()
    serializer_class = QrAccessSerializer
    permission_classes = [AllowAny]
    filter_backends = (DjangoFilterBackend, SearchFilter, OrderingFilter,)
    filterset_class = QrAccessFilter

    search_fields = ['validity_date_start', 'validity_date_end']
    ordering_fields = ('validity_date_start', 'validity_date_end')
